...
export function InteractiveGradient() {
  ...
  // Use useMotionTemplate for reactive gradient updates
  const background = useMotionTemplate`radial-gradient(circle at ${springX}% ${springY}%, oklch(0.64 0.22 264.5 / 0.3), oklch(0.72 0.20 310 / 0.2), transparent 50%)`;
