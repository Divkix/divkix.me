...
I've shipped 30+ projects while getting my master's degree in Computer Science at ASU. None of them are perfect. Most serve specific needs. A few have actually scaled to real users—PickMyClass helps thousands of ASU students grab classes, Alita Robot serves 300K+ Telegram users.
...
Alita is a Telegram bot serving 300K+ users. I wrote it in Go, not TypeScript.
