...
seoTitle: "My 2026 Stack for Shipping 30+ Side Projects (MS CS, 250K+ Users)"
seoDescription: "I shipped 30+ projects while finishing my MS at ASU. Next.js, Supabase, Cloudflare — real lessons from tools serving 250K+ users."
...
faq:
  ...
  - q: "What about costs at scale?"
    a: "PickMyClass serves thousands of students on Cloudflare's free tier. Alita Robot (250K+ users) runs on minimal infra. Most projects never hit paid tiers."
...
I've shipped 30+ projects while getting my master's degree in Computer Science at ASU. None of them are perfect. Most serve specific needs. A few have actually scaled to real users—PickMyClass helps thousands of ASU students grab classes, Alita Robot serves 250K+ Telegram users.
...
Alita is a Telegram bot serving 250K+ users. I wrote it in Go, not TypeScript.
