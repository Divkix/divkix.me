---
title: "How I Scaled a Telegram Bot to 300k+ Users (Including the Tactics I'm Not Proud Of)"
seoTitle: "How I Scaled a Telegram Bot to 300k+ Users (Including the Tactics I'm Not Proud Of)"
seoDescription: "300K real users, 200 GitHub stars. The growth playbook nobody shares—directory blitzing, admin favor-trading, and the Python-to-Go rewrite that changed everything."
coverAlt: "Growth chart showing Telegram bot scaling from zero to 300K users over six years"
date: "2026-01-16"
...
Alita Robot grew from 0 to 300K+ users through directory saturation, admin partnerships, and a Python-to-Go rewrite that differentiated it from every other open-source Telegram bot manager. Growth was 20% code, 80% hustle — seeding the first 10,000 users manually before word-of-mouth kicked in.
...
The first version was Python. I chose Python because I knew it, it had excellent Telegram libraries (python-telegram-bot), and I could ship something in a weekend. That "ship with what you know" instinct still drives my [side project stack today](/blog/side-project-stack-2026-grad-student). The goal wasn't to "beat" Miss Rose—it was to have something open source that people could actually modify.
...
Not exactly viral. But I learned something important: the people who did use it were _passionate_ about self-hosting. They didn't want my hosted version—they wanted to run their own.
...
I did this for about 20 groups over 3 months. That's 300 hours of free labor. In return, I got:
...
Compared to the Python version, the Go rewrite reduced memory consumption by 65% and queries completed 3x faster. That alone justified the 2 months I spent on it.

## Python vs Go for Telegram Bots

| Aspect             | Python (v1)         | Go (v2)               | Impact                         |
| ------------------ | ------------------- | --------------------- | ------------------------------ |
| **Memory Usage**   | ~400MB              | ~140MB                | 65% reduction                  |
| **Query Speed**    | ~120ms              | ~40ms                 | 3x faster                      |
| **Concurrency**    | Threads + asyncio   | Goroutines + channels | Handles 300K users without lag |
| **Binary Size**    | ~15MB               | ~12MB                 | Smaller deploy                 |
| **Ecosystem**      | python-telegram-bot | gotgbot               | Both mature, Go is rarer       |
| **Learning Curve** | Low                 | Medium                | 2 months to rewrite            |

The rewrite wasn't just about performance. It was about standing out in a sea of Python bots. Go made Alita different, and different got attention.

## Riding the Wave (Year 2-3)

Something interesting happened as Alita matured: people started making their own Telegram bots.

The bot-making wave hit hard. Everyone wanted their own group management bot. GitHub search traffic for "Telegram bot Go" increased by 150% during this 12-month period. Most were closed-source knockoffs of existing bots. But some developers wanted to learn, to customize, to actually understand what they were running.
...
> **Statistic:** Alita Robot grew to 300,000+ total users across 12,000+ active groups, with monthly active users around 40,000.
...
4. **Feature parity** - Users didn't switch to Alita because we had more features. They switched because they wanted open source and self-hosting. The lesson applies beyond Telegram bots — [tools that solve a genuine pain point](/blog/pickmyclass-never-miss-your-dream-class) win over feature-checklist competitors every time.
...
**Inflated metrics** - "300k+ users" is technically accurate but misleading. I know this. I used it anyway because it's what gets attention — a small case study in [the authenticity paradox of presenting yourself online](/blog/authenticity-paradox-online-persona).
...
Am I as active on it as I used to be? No. But I make sure no GitHub issue goes unanswered, no user concern gets ignored. [Centralized logging across my projects](/blog/logwell-self-hosted-logging-platform) means most issues surface before users even notice. The bot still has bugs—I fix them as they come up.
...
_Alita Robot is open source and available at [github.com/divkix/Alita_Robot](https://github.com/divkix/Alita_Robot) or try the live bot at [t.me/Alita_Robot](https://t.me/Alita_Robot). If you're running a Telegram group and want a self-hosted admin bot, give it a try. Just don't ask me to do your personal setup—I'm retired from that particular hustle._

## Related Posts

- [My Side Project Stack in 2026](/blog/side-project-stack-2026-grad-student/) — The tools and infrastructure behind my side projects
- [The Truth About Vibe Coding](/blog/vibe-coding-truth-ai-programming-2026/) — Lessons on when AI-assisted development works and when it doesn't
- [PickMyClass: Never Miss Your Dream Class](/blog/pickmyclass-never-miss-your-dream-class/) — Another side project that grew beyond expectations
