...
coverAlt: "LM Studio running local AI models on a MacBook Pro with Apple Silicon"
...
howToSteps:
  - name: "Download and install LM Studio"
    text: "Go to lmstudio.ai and download the app for macOS. No account or credit card required."
  - name: "Browse and download a model"
    text: "Open the Discover tab, search for Qwen-7B or Qwen3-VL-8B, and click Download. Models are hosted on Hugging Face."
  - name: "Load the model and start chatting"
    text: "Click Load on the downloaded model, then switch to the Chat tab and start typing. Everything stays on your machine."
  - name: "Use vision models for screenshots"
    text: "With a vision model loaded, paste a screenshot into the chat and ask questions about it. The model understands visual context."
sources:
  - "https://lmstudio.ai"
...
Not sure [which model to run](/blog/ai-models-compared-2026)? Here's what works at different RAM levels:
