...
faq:
  ...
  - q: "Is this production-ready?"
    a: "I'm running it in production for my own projects. It's single-user, no rate limiting, no retention policies yet—but the core logging works."
...
Logwell runs on my VPS, collecting logs from [Alita Robot](/blog/side-project-stack-2025-grad-student) (the Telegram bot) and the [PickMyClass](/blog/pickmyclass-never-miss-your-dream-class) scraper. Around 800K logs in the database right now, oldest from about 3 months ago.
...
- **Log retention policies** — Old logs accumulate forever. I manually DELETE FROM log WHERE timestamp < '...' periodically. Not ideal.
...
- [My 2025 Stack for Shipping Side Projects](/blog/side-project-stack-2025-grad-student) — The full toolkit, including why centralized logging matters
...
- [Vibe Coding in 2025](/blog/vibe-coding-truth-ai-programming-2025) — When AI-generated code works and when it bites you
