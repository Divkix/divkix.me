...
const Projects = dynamic(() => import("@/components/sections/Projects").then((mod) => ({
  default: mod.Projects,
})), {
  loading: () => <div className="min-h-screen" />,
})

const Experience = dynamic(() => import("@/components/sections/Experience").then((mod) => ({
  default: mod.Experience,
})), {
  loading: () => <div className="min-h-screen" />,
})

const Skills = dynamic(() => import("@/components/sections/Skills").then((mod) => ({
  default: mod.Skills,
})), {
